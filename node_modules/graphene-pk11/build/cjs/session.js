...
exports.Session = exports.UserType = exports.SessionFlag = void 0;
            ...
            if (callback) {
                this.lib.C_UnwrapKey(this.handle, pMech, unwrappingKey.handle, wrappedKey, pTemplate, (err, hKey) => {
                    if (err) {
                        ...
                        callback(null, new objects_1.Key(hKey, this, this.lib));
                    }
                });
            }
            else {
                const hKey = this.lib.C_UnwrapKey(this.handle, pMech, unwrappingKey.handle, wrappedKey, pTemplate);
                return new objects_1.Key(hKey, this, this.lib);
            }
        }
        catch (e) {
            const error = (0, error_1.prepareError)(e);
            ...
            if (callback) {
                this.lib.C_DeriveKey(this.handle, pMech, baseKey.handle, pTemplate, (err, hKey) => {
                    if (err) {
                        ...
                        callback(null, new objects_1.SecretKey(hKey, this, this.lib));
                    }
                });
            }
            else {
                const hKey = this.lib.C_DeriveKey(this.handle, pMech, baseKey.handle, pTemplate);
                return new objects_1.SecretKey(hKey, this, this.lib);
            }
        }
        catch (e) {
            const error = (0, error_1.prepareError)(e);
